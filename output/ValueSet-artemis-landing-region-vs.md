# Artemis Landing Regions - v0.5.12

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Artemis Landing Regions**

## ValueSet: Artemis Landing Regions 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/uv/aerospace/ValueSet/artemis-landing-region-vs | *Version*:0.5.12 |
| Active as of 2026-03-26 | *Computable Name*:ArtemisLandingRegionVS |
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "system" : "http://hl7.org/fhir/uv/aerospace/CodeSystem/artemis-landing-region-cs"
      }
    ]
  }
}
