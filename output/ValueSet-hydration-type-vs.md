# Hydration Types - v0.5.12

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Hydration Types**

## ValueSet: Hydration Types 

| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/ValueSet/hydration-type-vs | *Version*:0.5.12 |
| Active as of 2026-03-26 | *Computable Name*:HydrationTypeVS |
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://mitre.org/fhir/space-health/CodeSystem/hydration-type-cs"
      }
    ]
  }
}
