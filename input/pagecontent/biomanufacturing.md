...
- **[Bioreactor Device](StructureDefinition-bioreactor-device.html)** – Extends `Device` with:
...
- **[Biomanufacturing Procedure](StructureDefinition-biomanufacturing-procedure.html)** – Documents in-situ resource utilization (ISRU) bioprocessing, algae cultivation, fermentation, or downstream processing with:
  - Process parameters (duration, temperature, feedstock input)
  - Strain or cell line used
  - Yield and efficiency metrics
  - Quality control checkpoints

- **[BLiSS Resource Output](StructureDefinition-bliss-resource-output.html)** – Standardized observation of system-level outputs:
  - O₂ production rate
  - Food / biomass output
...
- **[Biological Feedstock](StructureDefinition-biological-feedstock.html)** – Characterizes input or output biological substances:
...
- [Algae Photobioreactor](Device-Bioreactor-Algae-001.html)
- [Algae Cultivation Procedure](Procedure-Biomanufacturing-AlgaeCultivation-001.html)
- [BLiSS O2 Production Output](Observation-BLiSS-O2-Production-001.html)

### Standardized Terminologies

- [Biomanufacturing Process Code System](CodeSystem-biomanufacturing-process-cs.html) and [Value Set](ValueSet-biomanufacturing-process-vs.html) – algae-photobioreactor, fermentation-bioreactor, isru-processor, biocement-production, pharmaceutical-synthesis, biomass-conversion
- [BLiSS Output Code System](CodeSystem-bliss-output-cs.html) and [Value Set](ValueSet-bliss-output-vs.html) – resource categories produced by a bioregenerative life support system (o2-production, food-production, water-recycling, biofuel-production, co2-fixation, biomaterial-output)
- [Biomanufacturing Metric Code System](CodeSystem-biomanufacturing-metric-cs.html) – output-quantity, output-rate, energy-input
