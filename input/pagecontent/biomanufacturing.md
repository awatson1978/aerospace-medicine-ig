...
**Core Profiles**
- **[`BioreactorDevice`](StructureDefinition-bioreactor-device.html)** – Extends `Device` with:
...
- **[`BiomanufacturingProcedure`](StructureDefinition-biomanufacturing-procedure.html)** – Documents ISRU bioprocessing, algae cultivation, fermentation, or downstream processing with:
  - Process parameters (duration, temperature, feedstock input)
  - Strain or cell line used
  - Yield and efficiency metrics
  - Quality control checkpoints

- **[`BLiSSResourceOutput`](StructureDefinition-bliss-resource-output.html)** – Standardized observation of system-level outputs:
  - O₂ production rate
  - Food / biomass output
...
- **[`BiologicalFeedstock`](StructureDefinition-biological-feedstock.html)** – Characterizes input or output biological substances:
...
- [`BiomanufacturingProcessCS`](CodeSystem-biomanufacturing-process-cs.html) – (algae-cultivation, microbial-fermentation, enzymatic-recycling, isru-biopolymer)
- `BLiSSResourceTypeVS` (proposed): resource categories produced by a bioregenerative life support system
