...
6. Cardiovascular conditions including hypertension, arrhythmias, heart murmur, valve replacement, or other circulatory issues
7. Height between 4 ft 0 in (1.22 m) and 6 ft 2 in (1.88 m)
8. Weight less than 250 lb (113.4 kg)
...
3. Complete the [G-SHOCK Centrifugal Trainer Eligibility Questionnaire](Questionnaire-GShockEligibility.html)
...
3. Update the training progression plan based on performance and tolerance

### FHIR Profiles and Extensions

The screening bundle is made up of the following artifacts, all of which exist in this guide:

- [Gimbal Screening](StructureDefinition-gimbal-screening.html): a Bundle profile of type `document` whose entries carry the contraindicated Conditions, Procedures, Medications, and Observations reviewed before a ride
- [G-SHOCK Centrifugal Trainer Eligibility Questionnaire](Questionnaire-GShockEligibility.html): the pre-screening eligibility questionnaire completed by the trainee
- [Gimbal Contraindications](ValueSet-gimbal-contraindicated-conditions-vs.html): SNOMED CT concepts for the contraindicated conditions and procedures
...
2. **RiskAssessment**: Evaluation of individual risk factors for adverse reactions
3. **CarePlan**: Personalized training progression based on adaptation and performance
...
- [Space Motion Sickness Episode - Flight Day 2](Condition-SMS-Episode-FD2.html): a Condition example for a motion-sickness episode
- [Promethazine IM Rescue Dose](MedicationAdministration-Promethazine-IM-Rescue.html): a MedicationAdministration example for antiemetic rescue treatment
