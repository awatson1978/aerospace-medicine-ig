...
- **[Multi-Omics Observation](StructureDefinition-multi-omics-observation.html)** – Captures platform, read counts, quality metrics, and cross-omics correlations for any assay (genomics, proteomics, metabolomics, etc.)
- **[Space Molecular Sequence](StructureDefinition-space-molecular-sequence.html)** – Extends `MolecularSequence` with spaceflight context (mission phase, radiation exposure, microgravity duration, telomere dynamics)
- **[Omics Risk Assessment](StructureDefinition-omics-risk-assessment.html)** – Personalized risk scores derived from multi-omic signatures (telomere, cytokine, immune activation, cell-type shifts)
- **[Personalized Countermeasure Plan](StructureDefinition-personalized-countermeasure-plan.html)** – Links omics-derived risks to individualized interventions (exercise, nutrition, pharmacologic, sleep, radiation countermeasures)
- **[Biobank Location](StructureDefinition-biobank-location.html)** (extension) – Records where a specimen is banked so that a Specimen can be traced back to CAMbank or another repository
...
- [Dried Blood Spot Specimen with Biobank Metadata](Specimen-DBS-Specimen-001.html)
- [Metabolomics Observation](Observation-Metabolomics-Observation-001.html)
- [Personalized Countermeasure Plan](CarePlan-PersonalizedPlan-001.html)

### Standardized Terminologies

- [Space Omics Type Code System](CodeSystem-space-omics-type-cs.html) and [Value Set](ValueSet-space-omics-type-vs.html) – genomics, transcriptomics, proteomics, metabolomics, epigenomics, microbiomics, lipidomics
- [Expanded Specimen Type Code System](CodeSystem-expanded-specimen-type-cs.html) and [Value Set](ValueSet-expanded-specimen-type-vs.html) – dried-blood-spot, extracellular-vesicle, nasal/skin/oral/gut microbiome samples, hair-follicle, exhaled-breath-condensate
- Mission context for an omics observation uses the shared [Mission Phase](CodeSystem-mission-phase-cs.html) and [Gravity Context](CodeSystem-gravity-context-cs.html) code systems rather than an omics-specific value set
...
- [Radiation Exposure Tracking](radiation-tracking.html) – telomere length and DNA-damage signatures
- [Neurocognitive Monitoring](neurocognitive-monitoring.html) – cytokine/BDNF changes and immune-brain axis
- [Cardiovascular Countermeasures](cardiovascular-countermeasures.html) – inflammatory and endothelial responses
- [Exercise](fitness.html) and [Metabolic Suppression](metabolic-hibernation.html) – energy-expenditure and recovery trajectories
- [ECLSS](eclss.html) / [Nutrition](nutrition.html) – microbiome and metabolomics in closed-loop systems
