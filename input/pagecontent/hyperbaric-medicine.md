...
Decompression sickness risk is a key concern shared by divers and astronauts. The [`DecompressionSickness`](StructureDefinition-decompression-sickness.html) profile extends the space medicine condition profile to capture:
...
|------------------|------------------|---------|
| **Conditions** | [`DecompressionSickness`](StructureDefinition-decompression-sickness.html), [`BarotraumaAssessment`](StructureDefinition-barotrauma-assessment.html) | Document DCS cases and pressure-related injuries |
| **Treatments** | [`HyperbaricTreatment`](StructureDefinition-hyperbaric-treatment.html), [`EnhancedHyperbaricTreatment`](StructureDefinition-enhanced-hyperbaric-treatment.html) | Capture hyperbaric therapy protocols and outcomes |
| **Facilities** | [`HyperbaricChamber`](StructureDefinition-hyperbaric-chamber.html) | Track chamber specifications and capabilities |
| **Protocols** | [`DecompressionProtocol`](StructureDefinition-decompression-protocol.html) | Standardize decompression procedures |

### Examples

- [Example Hyperbaric Chamber](Location-ExampleHyperbaricChamber.html) and [NASA Hyperbaric Facility](Location-NASAHyperbaricFacility.html): chamber locations recorded with the [`HyperbaricChamber`](StructureDefinition-hyperbaric-chamber.html) profile, showing chamber type, maximum pressure, and treatment capabilities.
- [Hyperbaric Treatment Chamber](Location-HyperbaricChamberFacility.html): a plain Location record for a treatment facility attached to an underwater training centre.
...
- **[`HyperbaricCapabilitiesCS`](CodeSystem-hyperbaric-capabilities-cs.html)**: Treatment capabilities a chamber offers
- **[`HyperbaricChamberTypeCS`](CodeSystem-hyperbaric-chamber-type-cs.html)**: Monoplace, multiplace, and portable chamber types
...
- **[`HyperbaricCapabilities`](ValueSet-hyperbaric-capabilities-vs.html)**: Chamber capability codes
- **[`HyperbaricChamberType`](ValueSet-hyperbaric-chamber-type-vs.html)**: Chamber type codes
