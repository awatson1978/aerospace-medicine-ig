...
The structure offers a model for FHIR-based spaceflight medical forms. This guide already carries a FHIR rendering of the form as the [FAA Form 8500-8 Questionnaire](Questionnaire-FAA8500Questionnaire.html).
...
- Mission phase and gravity environment can be coded with this guide's [`MissionPhaseCS`](CodeSystem-mission-phase-cs.html) and [`GravityContextCS`](CodeSystem-gravity-context-cs.html)
...
This guide's condition value sets for specific training devices can be reused as answer lists: [Gimbal Contraindications](ValueSet-gimbal-contraindicated-conditions-vs.html) and [Diving Contraindicated Conditions](ValueSet-diving-contraindicated-conditions-vs.html).
...
- [Astronaut Flight Readiness Questionnaire](Questionnaire-AstronautFlightReadinessQuestionnaire.html): the spaceflight readiness form modelled on the outline in this page
- [FAA Form 8500-8 Questionnaire](Questionnaire-FAA8500Questionnaire.html): the aviation medical application used as the baseline
- [G-SHOCK Centrifugal Trainer Eligibility Questionnaire](Questionnaire-GShockEligibility.html): a device-specific screening questionnaire
- [NASA HERA Analog Mission Application](Questionnaire-HERAAnalogMissionApplication.html): an analog-mission application form
- [Astronaut](StructureDefinition-astronaut.html): the Patient profile used as the subject of screening records
