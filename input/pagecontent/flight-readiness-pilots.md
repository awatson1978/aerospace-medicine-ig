...
This guide's mapping of Form 8500-8 to a FHIR Questionnaire, published here as the [FAA Form 8500-8 Questionnaire](Questionnaire-FAA8500Questionnaire.html), shows that all medically relevant fields in the form can be expressed and transmitted via Fast Healthcare Interoperability Resources (FHIR) APIs [7][8]. Key findings from that mapping include:
...
The [FAA Form 8500-8 Questionnaire](Questionnaire-FAA8500Questionnaire.html) uses SNOMED CT for conditions, LOINC for examinations and laboratory tests, and RxNorm for medications, following the conventions of HL7 US Core [8].
