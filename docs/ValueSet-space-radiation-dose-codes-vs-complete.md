# Complete Space Radiation Dose Measurement Codes - v0.5.2
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/ValueSet/space-radiation-dose-codes-vs-complete | *Version*:0.5.2 |
