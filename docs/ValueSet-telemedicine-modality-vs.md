# Telemedicine Modality Value Set - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Telemedicine Modality Value Set**

## ValueSet: Telemedicine Modality Value Set (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/telemedicine-modality-vs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:TelemedicineModalityVS |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/telemedicine-modality-vs",
  "version" : "0.7.0",
