# Behavioral Health State - v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/uv/aerospace/StructureDefinition/behavioral-health-state | *Version*:0.6.0 |
| Active as of 2026-05-25 | *Computable Name*:BehavioralHealthState |
