# Behavioral Health State - v0.5.0
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/uv/aerospace/StructureDefinition/behavioral-health-state | *Version*:0.5.0 |
| Active as of 2025-12-25 | *Computable Name*:BehavioralHealthState |
