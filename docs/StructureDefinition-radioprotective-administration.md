# Radioprotective Medication Administration - v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/radioprotective-administration | *Version*:0.6.0 |
| Active as of 2026-05-25 | *Computable Name*:RadioprotectiveAdministration |
...
```json
{
  ...
  "url" : "https://mitre.org/fhir/space-health/StructureDefinition/radioprotective-administration",
  "version" : "0.6.0",
      ...
      },
      {
        ...
        "type" : [
          ...
          },
          {
            "code" : "Reference",
            "targetProfile" : [
              "https://mitre.org/fhir/space-health/StructureDefinition/radioprotective-medication"
            ]
          }
        ],
        "mustSupport" : true
