# EVA Systems - Aerospace Medicine Implementation Guide v0.7.0
...
* **[xEVAS Suit Definition](StructureDefinition-xevas-suit-definition.md)** – Standardized description of a specific xEVAS suit model with: 
...
* Current configuration, via the [Suit Operational State](StructureDefinition-suit-operational-state.md) extension
 
* **[EVA Suit Provisioning Record](StructureDefinition-eva-suit-provisioning-record.md)** – Tracks logistics and delivery of suits and components: 
...
* **[Suit Redundancy Assessment](StructureDefinition-suit-redundancy-assessment.md)** – Captures current redundancy status for EVA operations: 
...
* [xEVAS Lunar Suit Definition](DeviceDefinition-xEVAS-LunarSuit-Def-001.md) – a suit model configured for planetary-surface EVA
* [Artemis IV Suit Provisioning](SupplyDelivery-ArtemisIV-SuitProvisioning-001.md) – suits pre-positioned for the first crewed south-pole landing
* [ISS Suit Redundancy Assessment](Observation-SuitRedundancy-Assessment-001.md) – primary and backup suit status with consumables remaining

### Standardized Terminologies

* [EVA Suit State Code System](CodeSystem-eva-suit-state-cs.md) and [Value Set](ValueSet-eva-suit-state-vs.md) – microgravity-config, planetary-surface-config, iva-rescue-config, pressurization-test, stowed
* [Suit Provisioning Status Code System](CodeSystem-suit-provisioning-status-cs.md) and [Value Set](ValueSet-suit-provisioning-status-vs.md) – pre-positioned, in-transit, deployed-primary, deployed-backup, maintenance-required, end-of-life
* [EVA Suit Inventory Metric Code System](CodeSystem-eva-suit-inventory-metric-cs.md) – primary-suit-status, backup-suit-status, consumables-remaining, next-maintenance-due
...
* [Space Telemedicine](space-telemedicine.md) (real-time suit telemetry consults)
* [Crew Evacuation and Emergency Response](crew-rescue.md) (EVA abort scenarios)
* [Planetary Protection](planetary-protection.md) (suit decontamination)
* [ECLSS](eclss.md) (suit life-support interface)
