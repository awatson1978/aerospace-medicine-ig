...
* **[`XEVASSuitDefinition`](StructureDefinition-xevas-suit-definition.md)** – Standardized description of a specific xEVAS suit model with: 
...
* **[`EVASuitProvisioningRecord`](StructureDefinition-eva-suit-provisioning-record.md)** – Tracks logistics and delivery of suits and components: 
...
* **[`SuitRedundancyAssessment`](StructureDefinition-suit-redundancy-assessment.md)** – Captures current redundancy status for EVA operations: 
...
* Futurism Editorial Staff. “Problem: SpaceX & Boeing Suits Not Compatible for Rescue.” **Futurism**. [https://futurism.com/stranded-astronauts-spacex-boeing-spacesuits-incompatible](https://futurism.com/stranded-astronauts-spacex-boeing-spacesuits-incompatible)
