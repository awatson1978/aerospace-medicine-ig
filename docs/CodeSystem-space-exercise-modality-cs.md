# Space Exercise Modality Code System - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Space Exercise Modality Code System**

## CodeSystem: Space Exercise Modality Code System (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/CodeSystem/space-exercise-modality-cs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:SpaceExerciseModalityCS |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/CodeSystem/space-exercise-modality-cs",
  "version" : "0.7.0",
