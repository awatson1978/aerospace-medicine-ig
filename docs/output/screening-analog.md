# Analog Mission Training - v0.5.10
...
1. UNOOSA (2019).**My Two Weeks as an Analog Astronaut**.
1. SatNews (2024). "Martians Wanted: NASA opens call…"
1. Blooloop (2022). "Star Harbor plans world’s first training facility…"
1. MMAARS (2025). FAQ and Program Overview.
1. The Space Review (2008). "Screening and Training for Commercial Human Spaceflight."
1. Nature npj Microgravity (2024). ESA Topical Team Review.
