# Environmental Monitoring API for Closed Biome Systems - v0.5.2
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/EnvironmentalMonitoringLogicalModel | *Version*:0.5.2 |
