# Communication Session Assessment - v0.5.5
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/communication-session-assessment | *Version*:0.5.5 |
