# Communication Session Assessment - v0.5.4
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/communication-session-assessment | *Version*:0.5.4 |
