# Regulatory Standards for Diving and Space Medicine - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Regulatory Standards for Diving and Space Medicine**

## ValueSet: Regulatory Standards for Diving and Space Medicine (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/regulatory-standards-vs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:RegulatoryStandards |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/regulatory-standards-vs",
  "version" : "0.7.0",
