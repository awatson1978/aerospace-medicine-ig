# Space Exercise Vital Sign Minutes Per Week - v0.5.2
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/space-evs-minutes-per-week | *Version*:0.5.2 |
