# Mars Direct - Aerospace Medicine Implementation Guide v0.7.0
...
**FHIR modeling**: [ISRUProductionLog](StructureDefinition-isru-production-log.md) Observations track output, reactor status, and alarms. Not directly medical, but ISRU status feeds risk assessments and crew stress monitoring.
...
All resources link to the [MissionContext](StructureDefinition-mission-context.md) extension and to the [MarsMissionsCS](CodeSystem-mars-missions-cs.md) and [CrewedMarsMissionsCS](CodeSystem-crewed-mars-missions-cs.md) code systems.
...
* [MissionContext](StructureDefinition-mission-context.md) — Links a resource to a specific Mars mission Encounter and phase
* [AreographicCoordinates](StructureDefinition-areographic-coordinates.md) — Mars latitude and longitude for Location resources
* [ISRUStatus](StructureDefinition-isru-status.md) — Links to ISRU production status
* [EVANumber](StructureDefinition-eva-number.md) — Sequential EVA identifier (shared with the Artemis module)
* [CommunicationDelay](StructureDefinition-communication-delay.md) — One-way light-time lag for transmissions

#### Profiles

* [MarsEVAProcedure](StructureDefinition-mars-eva-procedure.md): Surface EVAs—duration, location, participants, suit, metabolic data, dust exposure, post-EVA health check
* [HabitatEnvironmentalObservation](StructureDefinition-habitat-environmental-observation.md): Atmospheric monitoring—O₂ %, CO₂, pressure, temperature, humidity, dust; subject is the habitat Location
* [ISRUProductionLog](StructureDefinition-isru-production-log.md): ISRU output—propellant mass (kg CH₄, O₂), reactor status, power; links to the ISRU plant Device
* [MarsCrewMemberProfile](StructureDefinition-mars-crew-member.md): Patient—radiation career dose, flight certification, bone baseline, resilience score
* [MissionTimelinePlan](StructureDefinition-mission-timeline-plan.md): PlanDefinition—phases (launch, transit, operations, return), medical protocols, EVA schedules
* [MarsRadiationRiskAssessment](StructureDefinition-mars-radiation-risk-assessment.md): Long-duration exposure—basis is cumulative dose; prediction is cancer/CNS risk
* [AutonomousMedicalEncounter](StructureDefinition-autonomous-medical-encounter.md): Crew-led events with no real-time ground support; groups Observations, Procedures, Conditions, and Medications with communication-delay context
...
* [Mars Direct Mission 2040](Encounter-MarsDirectMission2040.md) — Encounter spanning the whole mission
* [Mars Direct Mission Plan 2040](PlanDefinition-MarsDirectMissionPlan2040.md) — MissionTimelinePlan with phases and EVA schedule
* [Mars Crew Member - Commander Chen](Patient-MarsCrewMember1.md) and [Mission Specialist Okafor](Patient-MarsCrewMember2.md) — crew Patient records
* [Mars Surface Habitat - Jezero Crater](Location-MarsHabitat-Jezero.md) — habitat Location with areographic coordinates
* [ISRU Propellant Production Plant](Device-ISRU-Plant-Jezero-1.md) — ISRU plant Device
* [Habitat Environmental Conditions - Sol 125](Observation-HabitatEnvironment-Sol125.md) — HabitatEnvironmentalObservation
* [ISRU Production Log - Sol 210](Observation-ISRU-Production-Sol210.md) — ISRUProductionLog
* [Mars EVA - Sol 147](Procedure-MarsEVA-Sol147.md) — MarsEVAProcedure
* [Cumulative Radiation Dose - Outbound Transit](Observation-CumulativeDose-Transit.md) — CumulativeRadiationDose for the six-month transit
* [Radiation Risk Assessment - Post Outbound Transit](RiskAssessment-RadiationRisk-PostTransit.md) — MarsRadiationRiskAssessment
* [Autonomous Medical Encounter - Appendicitis Sol 189](Encounter-Emergency-Appendicitis-Sol189.md) — AutonomousMedicalEncounter for the illustrative surgery scenario
...
* [MarsMissionsCS](CodeSystem-mars-missions-cs.md) / [MarsMissionsVS](ValueSet-mars-missions-vs.md): Robotic missions (Mariner 4, Viking, Pathfinder, Spirit, Opportunity, Curiosity, Perseverance) plus future crewed missions
* [CrewedMarsMissionsCS](CodeSystem-crewed-mars-missions-cs.md) / [CrewedMarsMissionsVS](ValueSet-crewed-mars-missions-vs.md): Architectures (Mars Direct, DRM 3.0, DRA 5.0, Starship, Olympus)
* [MarsLandingSitesCS](CodeSystem-mars-landing-sites-cs.md) / [MarsLandingSitesVS](ValueSet-mars-landing-sites-vs.md): Candidate sites with coordinates (Jezero, Arcadia, Gale, Elysium, Hellas, Mawrth)
* [MarsCertifiedDevicesCS](CodeSystem-mars-certified-devices-cs.md) / [MarsCertifiedDevicesVS](ValueSet-mars-certified-devices-vs.md): Flight-qualified hardware (Orion, Crew Dragon, ISS ECLSS, EMU, Bio-Monitor)
* [MarsPrototypeDevicesCS](CodeSystem-mars-prototype-devices-cs.md) / [MarsPrototypeDevicesVS](ValueSet-mars-prototype-devices-vs.md): Developmental hardware (Starship, Mars Habitat, xEMU, ISRU Plant, Kilopower, rovers)
* [MarsAllDevicesVS](ValueSet-mars-all-devices-vs.md): Combined certified and prototype devices
* [AerospaceObservationCategoryCS](CodeSystem-aerospace-observation-category-cs.md): Observation categories used by the habitat and ISRU profiles (environmental, ISRU)
* [ISRUMetricsCS](CodeSystem-isru-metrics-cs.md): Component codes for ISRU production logs (propellant mass, reactor status, power)
