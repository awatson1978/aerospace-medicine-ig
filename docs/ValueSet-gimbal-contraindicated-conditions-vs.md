# Gimbal Contraindications - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Gimbal Contraindications**

## ValueSet: Gimbal Contraindications (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/gimbal-contraindicated-conditions-vs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:GimbalContraindicatedConditions |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/gimbal-contraindicated-conditions-vs",
  "version" : "0.7.0",
