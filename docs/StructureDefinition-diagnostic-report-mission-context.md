# Mission Context for Diagnostic Reports - v0.5.2
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/diagnostic-report-mission-context | *Version*:0.5.2 |
