# Enhanced Neutral Buoyancy Training Session - v0.5.1
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/enhanced-neutral-buoyancy-session | *Version*:0.5.1 |
