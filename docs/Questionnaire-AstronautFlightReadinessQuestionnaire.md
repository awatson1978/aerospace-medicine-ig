# Astronaut and Space Tourist Medical Screening Questionnaire - v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/Questionnaire/AstronautFlightReadinessQuestionnaire | *Version*:0.6.0 |
