# Astronaut and Space Tourist Medical Screening Questionnaire - v0.5.8
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/Questionnaire/AstronautFlightReadinessQuestionnaire | *Version*:0.5.8 |
