# Behavioral Health Metrics Value Set - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Behavioral Health Metrics Value Set**

## ValueSet: Behavioral Health Metrics Value Set (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/behavioral-health-metrics-vs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:BehavioralHealthMetricsVS |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/behavioral-health-metrics-vs",
  "version" : "0.7.0",
