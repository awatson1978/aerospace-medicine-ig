# Crew Evacuation and Emergency Response - Aerospace Medicine Implementation Guide v0.7.0
...
* **[Space Emergency Condition](StructureDefinition-space-emergency-condition.md)** – Standardized coding of emergency diagnosis (depressurization, fire, toxic atmosphere, medical) with severity, onset time, and affected modules/vehicles
* **[Emergency Evacuation Procedure](StructureDefinition-emergency-evacuation-procedure.md)** – Documents the specific evacuation or abort action taken (Dragon return, Soyuz undock, safe-haven relocation) including timestamps, crew roles, and outcome
* **[Emergency Risk Assessment](StructureDefinition-emergency-risk-assessment.md)** – Captures mission-phase and vehicle-specific risk context (e.g., probability categories for planning purposes) without performing statistical modeling
* **[Emergency Care Plan](StructureDefinition-emergency-care-plan.md)** – Links identified conditions to the full contingency plan, muster point, egress path, and post-evacuation medical follow-up
...
* [Rapid Depressurization Event](Condition-Emergency-RapidDepress-001.md)
* [Emergency Dragon Return](Procedure-Emergency-DragonReturn-001.md)
* [ISS Emergency Contingency Plan](CarePlan-ISS-Emergency-Plan-001.md)

### Standardized Terminologies

* [Space Emergency Type Code System](CodeSystem-space-emergency-type-cs.md) and [Value Set](ValueSet-space-emergency-type-vs.md) – rapid-depress, fire-onboard, toxic-atmosphere, medical-emergency, vehicle-malfunction, collision-debris, abort-launch, abort-entry
* [Emergency Response Code System](CodeSystem-emergency-response-cs.md) and [Value Set](ValueSet-emergency-response-vs.md) – crew-dragon-return, soyuz-return, orion-abort, safe-haven, emergency-eva, emergency-undock, crew-rescue-vehicle
...
* [Space Telemedicine](space-telemedicine.md) (real-time ground consultation during egress)
* [ECLSS](eclss.md) (toxic atmosphere and depressurization response)
* [Cardiovascular Countermeasures](cardiovascular-countermeasures.md) (medical evacuations)
* [Radiation Exposure Tracking](radiation-tracking.md) (storm-shelter or abort decisions)
* [Metabolic Suppression](metabolic-hibernation.md) (autonomous operations during communication blackout)
