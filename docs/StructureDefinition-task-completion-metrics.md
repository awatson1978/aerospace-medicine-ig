# Task Completion Metrics - v0.5.9
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/task-completion-metrics | *Version*:0.5.9 |
| Draft as of 2026-02-04 | *Computable Name*:TaskCompletionMetrics |
