# Task Completion Metrics - v0.5.0
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/task-completion-metrics | *Version*:0.5.0 |
| Draft as of 2025-12-25 | *Computable Name*:TaskCompletionMetrics |
