# Task Completion Metrics - v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/task-completion-metrics | *Version*:0.6.0 |
| Draft as of 2026-05-25 | *Computable Name*:TaskCompletionMetrics |
