# Task Completion Metrics - v0.6.2
...
| | |
| :--- | :--- |
| *Official URL*:https://mitre.org/fhir/space-health/StructureDefinition/task-completion-metrics | *Version*:0.6.2 |
| Draft as of 2026-08-03 | *Computable Name*:TaskCompletionMetrics |
