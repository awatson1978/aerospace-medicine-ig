# Space Motion Sickness Value Set - Aerospace Medicine Implementation Guide v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Space Motion Sickness Value Set**

## ValueSet: Space Motion Sickness Value Set (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/space-motion-sickness-vs | *Version*:0.7.0 |
| Active as of 2026-09-02 | *Computable Name*:SpaceMotionSicknessVS |
...
```json
{
  ...
  "url" : "https://awatson1978.github.io/aerospace-medicine-ig/ValueSet/space-motion-sickness-vs",
  "version" : "0.7.0",
