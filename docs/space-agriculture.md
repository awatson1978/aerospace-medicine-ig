# Space Agriculture - Aerospace Medicine Implementation Guide v0.7.0
...
This content extends the [ECLSS](eclss.md) and [Nutrition](nutrition.md) sections of the Aerospace Medicine IG and supports:

* Closed-loop life support monitoring
* Food safety surveillance for pick-and-eat crops
* Environmental microbiology in habitats (see [Planetary Protection](planetary-protection.md))
...
1. Landon et al. Sustaining the Merry Space farmer with pick-and-eat crop production.**npj Microgravity**11, 72, 2025.[https://doi.org/10.1038/s41526-025-00513-9](https://doi.org/10.1038/s41526-025-00513-9)
1. Spern et al. The microbial communities of a tomato crop grown in Veggie under different lighting regimes on the International Space Station.**Life Sciences in Space Research**, 2026.[https://doi.org/10.1016/j.lssr.2026.01.010](https://doi.org/10.1016/j.lssr.2026.01.010)
1. Dixit et al. Stress and light spectral quality influence the transcriptome of a tomato crop on the International Space Station.**BMC Plant Biology**, 2025. In press.
1. Khodadad CLM, et al. Microbiological and Nutritional Analysis of Lettuce Crops Grown on the International Space Station.**Frontiers in Plant Science**11:199, 2020.[https://doi.org/10.3389/fpls.2020.00199](https://doi.org/10.3389/fpls.2020.00199)
1. NASA.[Veggie plant growth system](https://www.nasa.gov/content/growing-plants-in-space)– project page.
