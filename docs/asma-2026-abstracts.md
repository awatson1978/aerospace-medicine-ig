# AsMA 2026 Abstracts - Aerospace Medicine Implementation Guide v0.7.0
...
| | | | |
| :--- | :--- | :--- | :--- |
| [1] | 47 | Cardiac arrhythmia risk | [SpaceECGObservation](StructureDefinition-space-ecg-observation.md) |
| [2] | 49 | Ultrasound joint health | [SpaceJointHealthAssessment](StructureDefinition-space-joint-health-assessment.md) |
| [3] | 50 | N-Acetylcysteine radioprotection | [RadioprotectiveMedication](StructureDefinition-radioprotective-medication.md),[AntioxidantBiomarkerPanel](StructureDefinition-antioxidant-biomarker-panel.md) |
| [4] | 51 | Oral body temperature | [SpaceBodyTemperature](StructureDefinition-space-body-temperature.md) |
| [5] | 52 | CGM in spaceflight | [SpaceCGMDevice](StructureDefinition-space-cgm-device.md),[SpaceCGMObservation](StructureDefinition-space-cgm-observation.md) |
| [6] | 53 | Torpor and sleep | [SpaceSleepStudy](StructureDefinition-space-sleep-study.md),[CircadianRhythmAssessment](StructureDefinition-circadian-rhythm-assessment.md) |
| [7] | 54 | RBC rehydration | [SpaceBloodProduct](StructureDefinition-space-blood-product.md),[SpaceTransfusionProcedure](StructureDefinition-space-transfusion-procedure.md) |
| [8] | 57 | Austere blood banking | [SpaceBloodProduct](StructureDefinition-space-blood-product.md) |
| [9] | 68 | UWF OCT-A for SANS | [SANSAssessment](StructureDefinition-sans-assessment.md) |
| [10] | 108 | Postpartum recovery after spaceflight | [BoneDensityObservation](StructureDefinition-bone-density-observation.md) |
| [11] | 110 | BMD measurement | [BoneDensityObservation](StructureDefinition-bone-density-observation.md) |
| [12] | 111 | Space travel anaemia | [SpaceflightAnemiaPanel](StructureDefinition-spaceflight-anemia-panel.md) |
| [13] | 112 | DCS susceptibility | [DCSRiskAssessment](StructureDefinition-dcs-risk-assessment.md) |
| [14][15] | 113, 114 | Surgical procedures, 3D printing | [SpaceSurgicalProcedure](StructureDefinition-space-surgical-procedure.md) |
| [16] | 117 | POCUS in austere environments | [SpacePOCUS](StructureDefinition-space-pocus.md) |
| [17] | 120 | Artemis II health stack | [ARCHeRActigraphyObservation](StructureDefinition-archer-actigraphy-observation.md),[ImmuneBiomarkerPanel](StructureDefinition-immune-biomarker-panel.md) |
