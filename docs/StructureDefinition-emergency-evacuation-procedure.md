...
## Resource Profile: Emergency Evacuation Procedure 
...
* Examples for this Profile: [Procedure/Emergency-DragonReturn-001](Procedure-Emergency-DragonReturn-001.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/mitre.fhir.spacehealth|current/StructureDefinition/emergency-evacuation-procedure)
...
Other representations of profile: [CSV](StructureDefinition-emergency-evacuation-procedure.csv), [Excel](StructureDefinition-emergency-evacuation-procedure.xlsx), [Schematron](StructureDefinition-emergency-evacuation-procedure.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Procedure.code",
        "path" : "Procedure.code",
        "short" : "Type of emergency response action",
        "min" : 1,
        "mustSupport" : true,
        "binding" : {
          "strength" : "extensible",
      ...
      },
      {
        ...
        "short" : "Reference to the SpaceEmergencyCondition",
        "mustSupport" : true
      },
      {
        "id" : "Procedure.outcome",
        "path" : "Procedure.outcome",
        "short" : "Outcome of evacuation procedure",
        "mustSupport" : true
      },
      {
        "id" : "Procedure.note",
        "path" : "Procedure.note",
        "short" : "Procedural details and timeline",
        "mustSupport" : true
      }
    ]
  }
