# Operational Status Value Set - v0.5.9
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/uv/aerospace/ValueSet/operational-status-vs | *Version*:0.5.9 |
| Active as of 2026-02-04 | *Computable Name*:OperationalStatusVS |
